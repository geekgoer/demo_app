...
#if XPAR_CPU_ID == 0
#define SHARED_MEM_PA  0x3FD00000UL  /* 修改：与 device tree 中的 vring0 地址一致 */
#else
#define SHARED_MEM_PA  0x3EF40000UL
#endif /* XPAR_CPU_ID */
#define SHARED_MEM_SIZE 0x100000UL  /* vring0(16KB) + vring1(16KB) + buffer(1MB) */
#define SHARED_BUF_OFFSET 0x8000UL  /* 32KB offset for buffer (vring0 + vring1) */
